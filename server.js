...
const watchDog = require('./server/utils/watchDog');
...
var DMM = require('./server/data/mapper/data-model-mapper');
const { include } = require('underscore');
var category_config = require('./server/data/mapper/catalogMap.js').category_config;
var item_config = require('./server/data/mapper/catalogMap.js').item_config;
var item_attr_config = require('./server/data/mapper/catalogMap.js').item_attr_config;
var item_price_config = require('./server/data/mapper/catalogMap.js').item_price_config;
...
server.listen(port, () => {
  log.info(`APP VERSION :${config.BASICS.APP_VERSION}`);
